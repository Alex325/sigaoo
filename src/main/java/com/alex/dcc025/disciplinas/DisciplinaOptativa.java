...
public class DisciplinaOptativa extends Disciplina{
    public DisciplinaOptativa(String codigo, String nome, List<ValidadorPreRequisito> preRequisitos, List<Disciplina> coRequisitos, int cargaHorariaSemanal) throws DisciplinaException {
