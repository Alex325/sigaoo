...
public class DisciplinaObrigatoria extends Disciplina{
    public DisciplinaObrigatoria(String codigo, String nome, List<ValidadorPreRequisito> preRequisitos, List<Disciplina> coRequisitos, int cargaHorariaSemanal) throws DisciplinaException {
